...
[F_inf,F_sup,Err]=derivative_calc(I_pi/3,N_veig,N_eigs)
[F_inf,F_sup,Err]=derivative_calc(I_pi/3-I_pi/1500,N_veig,N_eigs)
...
%%  calculate an approximate eigenfunction
    ...
    x_hat_0=x_recover_dc(v,mesh_eigs);
    norm_x_hat_0=x_hat_0'*B_cg_dc_with_bdry*x_hat_0;
